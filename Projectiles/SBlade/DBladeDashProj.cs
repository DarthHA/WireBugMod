namespace WireBugMod.Projectiles.SBlade
{
    ...
    public class DBladeDashProj : BaseSkillProj
    {
        ...
        public DBladeDashPhase Phase = DBladeDashPhase.Default;
        ...
        public override void AI()
        {
            ...
            if (Phase == AtkPowerUpPhase.Shoot)           //10帧
            {
                for (int i = 0; i < 2; i++)
                {
            ...
            else if (Phase == AtkPowerUpPhase.Drag)      //拉扯，可派生悬挂
            {
                for (int i = 0; i < 2; i++)
                {
